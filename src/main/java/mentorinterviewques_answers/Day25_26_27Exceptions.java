...
public class Day25_26_27Exceptions {
    public static void main(String[] args) {
      /*
        ...
        "Run" button therefore those are called RunTime Exceptions ((Unchecked Exception)".  All these exceptions  run time exceptions. they are not visible
        ...
        21-What is "Collections" --> Collections are for storing multiply data in the same data type. Collections are flexible for length.
