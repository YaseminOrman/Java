...
public class HashMap03 {
    public static void main(String[] args) {
        ...
        //Example 2: Type code to print the number of occurrences of letters in a sentence( homework)
      ...
      HashMap<String , Integer> occurrenceOfLetter = new HashMap<>();
      for(String w : letters){
          Integer numOfLetters=occurrenceOfLetter.get(w);
          if(numOfLetters==null){
              occurrenceOfLetter.put(w,1);
          }else{
              occurrenceOfLetter.put(w,numOfLetters+1);
          }
      }
        System.out.println(occurrenceOfLetter);
