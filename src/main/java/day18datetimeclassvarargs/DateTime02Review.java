...
public class DateTime02Review {
    public static void main(String[] args) {
        ...
        LocalTime ltInJapan = LocalTime.now(ZoneId.of("Asia/Tokyo"));
        LocalTime ltInGermany = LocalTime.now(ZoneId.of("Europe/Berlin"));
        long diff=ChronoUnit.HOURS.between(ltInJapan,ltInGermany);
